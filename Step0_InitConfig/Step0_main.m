...
config.t1 = [cran_dir '/BLSubj1_Data/Anatomy/t1.nii.gz'];
config.coords = [0,0,0; 0,-16,0; 0,-8,40];
config.dwi = [cran_dir '/BLSubj1_Data/Diffusion/dwi.nii.gz'];
config.bvecs = [cran_dir '/BLSubj1_Data/Diffusion/dwi.bvecs'];
config.bvals = [cran_dir '/BLSubj1_Data/Diffusion/dwi.bvals'];
